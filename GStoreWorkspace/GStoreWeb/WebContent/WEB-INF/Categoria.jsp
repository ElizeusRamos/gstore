...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Gerência - Categorias</title>
			...
			<table class="table table-dark">
				<thead>
					<tr>
						...
						<th scope="col">Categoria Ativa</th>
						<th scope="col"></th>
					</tr>
				</thead>
				<tbody>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        <form action="/GStoreWeb/CategoriaController">
		        	<div class="form-group">
		        		<label for="nome">Nome</label>
		        		<input class="form-control" type="text" id="nome" name="nome" aria-descriptedby="nomeHelp" required/>
		        		<small id="nomeHelp" class="form-text text-muted">Nome da categoria a ser adicionada</small>
		        	</div>
		      ...
		      <div class="modal-body">
		        <form action="/GStoreWeb/CategoriaController">
		        	...
		        	<div class="form-group">
		        		<label for="nome">Nome</label>
		        		<input class="form-control" type="text" id="nome" name="nome" aria-descriptedby="nomeHelp" required/>
		        		<small id="nomeHelp" class="form-text text-muted">Nome da categoria a ser alterada</small>
		        	</div>
